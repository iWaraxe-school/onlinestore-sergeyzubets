...
public class ProductName {
    ...
    public static ProductName of(String productName) {
        checkArgument(productName.length() > MIN_PRODUCT_NAME_LENGTH, NAME_IS_EMPTY_ERROR_MESSAGE);
        checkArgument(productName.length() <= MAX_PRODUCT_NAME_LENGTH, NAME_LENGTH_EXCEEDS_MAX_VALUE_ERROR_MESSAGE + productName.length());
